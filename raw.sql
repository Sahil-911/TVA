...
UPDATE Line SET content = 'Are you a coffee? Because you’re hot and sweet.' WHERE local_id = 3 AND project_id = 1 AND file_id = 1 AND line_id = 2;
UPDATE Line SET content = 'Are you a candy? Because you’re a treat' WHERE local_id = 3 AND project_id = 3 AND file_id = 1 AND line_id = 3;
UPDATE Line SET content = 'Are you a firework? Because you’re explosive and colorful.' WHERE local_id = 3 AND project_id = 1 AND file_id = 1 AND line_id = 4;
UPDATE Line SET content = 'Are you a diamond? Because you’re precious and rare.' WHERE local_id = 3 AND project_id = 1 AND file_id = 1 AND line_id = 5;
...
UPDATE Line SET content = 'Are you a painting? Because you’re a masterpiece.' WHERE local_id = 3 AND project_id = 1 AND file_id = 2 AND line_id = 4;
