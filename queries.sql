...
-- select * from "Collaborator";
-- INSERT INTO "Collaborator" VALUES(1,2,'project scheduler');
-- INSERT INTO "Version" VALUES(2,1,5,2);
select * from "Line" where local_id=4 and project_id=1;
UPDATE "Line" SET content = 'Hwy i am Om Gor !!!' WHERE local_id = 4 AND project_id = 1 AND file_id = 5 AND line_id = 3;
UPDATE "Line" SET content = 'Today is saturday' WHERE local_id = 4 AND project_id = 1 AND file_id = 5 AND line_id = 7;
UPDATE "Line" SET content = 'kal sunday hai !!' WHERE local_id = 4 AND project_id = 1 AND file_id = 5 AND line_id = 9;
UPDATE "Line" SET content = 'this is second last line ' WHERE local_id = 4 AND project_id = 1 AND file_id = 5 AND line_id = 11;
UPDATE "Line" SET content = 'this is last line' WHERE local_id = 4 AND project_id = 1 AND file_id = 5 AND line_id = 19;
INSERT INTO "Change"(Version_id,  Timeline_id,Project_id, File_id, Line_id, Previous_content, New_content)
SELECT 5 AS Version_id, 2 AS Timeline_id, "Local_2".Project_id,"Local_2".File_id , "Local_2".Line_id,
